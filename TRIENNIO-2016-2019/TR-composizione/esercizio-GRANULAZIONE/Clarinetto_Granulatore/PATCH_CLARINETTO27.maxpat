...
, 			{
				"box" : 				{
					...
					"numinlets" : 0,
					"numoutlets" : 0,
					"patching_rect" : [ 305.0, 174.0, 18.0, 22.0 ],
					"text" : "("
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 464.535400390625, 804.0, 82.0, 22.0 ],
					"text" : "onepole~ 300"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 425.0, 808.0, 29.5, 22.0 ],
					"text" : "-~"
				}
...
,
					"patching_rect" : [ 624.783333333333076, 213.210510273437649, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 727.5, 644.708358764648438, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 727.5, 612.0, 47.0, 22.0 ],
					"text" : "ctlin 24"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 549.5, 630.708358764648438, 57.0, 38.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "int" ],
					"patching_rect" : [ 608.5, 591.0, 47.0, 22.0 ],
					"text" : "ctlin 14"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 603.783333333333076, 251.210510273437649, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 747.0, 935.2515869140625, 78.0, 22.0 ],
					"text" : "clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 464.535400390625, 758.86614990234375, 50.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 425.0, 758.86614990234375, 30.0, 22.0 ],
					"text" : "*~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 608.5, 616.7122802734375, 52.0, 52.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"numinlets" : 3,
					"numoutlets" : 0,
					"patching_rect" : [ 398.0, 871.2122802734375, 386.0, 22.0 ],
					"text" : "poke~ signal"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 1097.666656494140625, 589.919662485351637, 61.0, 22.0 ],
					"text" : "r Nsamp1"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 3423.087180163034191, 1.0, 0, 0.0, 21294.255435435668915, 1.0, 0, 0.0, 39965.625254377227975, 1.0, 0, 0.0, 44100.0, 0.0, 0, 0.0 ],
