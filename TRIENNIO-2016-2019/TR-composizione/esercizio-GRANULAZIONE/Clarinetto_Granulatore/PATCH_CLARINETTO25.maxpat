...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 505.535400390625, 918.0, 82.0, 22.0 ],
					"text" : "onepole~ 100"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 466.0, 918.0, 29.5, 22.0 ],
					"text" : "-~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 799.783333333333076, 174.0, 72.0, 22.0 ],
					"text" : "mc.allpass~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 469.0, 219.0, 54.0, 22.0 ],
					"text" : "mc.adc~"
				}
...
,
					"patching_rect" : [ 668.783333333333076, 196.210510273437649, 61.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 647.783333333333076, 251.210510273437649, 108.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.549999999999955, 101.998230000000149, 23.0, 22.0 ],
					"text" : "r b"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 98.33333333333303, 14.210510273437649, 45.0, 22.0 ],
					"text" : "r Srate"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 170.33333333333303, 21.206588764648586, 40.0, 22.0 ],
					"text" : "r dur1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 26.33333333333303, 134.998230000000149, 59.0, 22.0 ],
					"text" : "set signal"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 271.549999999999955, 65.730606098632961, 24.0, 24.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 466.0, 743.7122802734375, 24.0, 24.0 ],
					"uncheckedcolor" : [ 0.207843137254902, 0.125490196078431, 0.231372549019608, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 466.0, 793.0, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 604.783333333333076, 135.181671142578125, 86.0, 22.0 ],
					"text" : "mc.gv_grain11"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 98.33333333333303, 318.292190571289211, 38.0, 22.0 ],
					"text" : "s end"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 26.33333333333303, 318.292190571289211, 41.0, 22.0 ],
					"text" : "s start"
				}
...
, 			{
				"box" : 				{
					"addpoints_with_curve" : [ 0.0, 0.0, 0, 0.0, 19159.950123143957171, 1.0, 0, 0.0, 44099.0, 0.0, 0, 0.0 ],
...
,
					"patching_rect" : [ 26.33333333333303, 289.339950571289137, 91.0, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
,
					"patching_rect" : [ 98.33333333333303, 256.230606098632961, 105.400000000000091, 22.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "int", "float" ],
					"patching_rect" : [ 170.33333333333303, 94.230606098632961, 29.5, 22.0 ],
					"text" : "t 0 f"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 242.33333333333303, 121.498230000000149, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.33333333333303, 121.498230000000149, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 170.33333333333303, 66.230606098632961, 92.0, 23.0 ],
					"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 98.33333333333303, 66.230606098632961, 62.000000000000114, 23.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 26.33333333333303, 167.210510273437649, 307.0, 69.0 ],
					"presentation" : 1,
