...
,
		...
		"boxes" : [ 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 901.166666666666629, 407.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 402.166666666666629, 351.0, 94.0, 22.0 ],
					"text" : "mc.svf~ 100 0.1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 901.166666666666629, 273.0, 300.0, 100.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 582.5, 190.0, 29.5, 22.0 ],
					"text" : "* 4."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 509.5, 179.0, 29.5, 22.0 ],
					"text" : "* 2."
				}
...
,
					...
					"patching_rect" : [ 194.0, 278.547843933105469, 150.0, 92.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 491.422790546875149, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 28.0, 465.0, 51.0, 22.0 ],
					"text" : "r voice2"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 402.166666666666629, 422.0, 68.0, 22.0 ],
					"text" : "mc.stereo~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 525.5, 254.547843933105469, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 402.0, 446.0, 84.0, 22.0 ],
					"text" : "mc.clip~ -1. 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 402.166666666666629, 390.0, 136.0, 22.0 ],
...
, 			{
				"box" : 				{
					...
					"parameter_enable" : 1,
					"patching_rect" : [ 402.0, 480.0, 68.0, 112.0 ],
					"saved_attribute_attributes" : 					{
						"valueof" : 						{
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 163.0, 254.547843933105469, 35.0, 22.0 ],
					"text" : "adc~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 376.0, 600.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 412.166666666666629, 600.0, 54.0, 22.0 ],
					"text" : "mc.dac~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 477.166666666666515, 486.0, 300.0, 100.0 ]
				}
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 86.25, 228.547843933105469, 62.0, 23.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 32.75, 228.547843933105469, 63.0, 23.0 ],
									"presentation" : 1,
...
, 							{
								"box" : 								{
									...
									"outlettype" : [ "", "bang" ],
									"parameter_enable" : 0,
									"patching_rect" : [ 34.0, 85.047843933105469, 45.0, 18.0 ],
									"presentation" : 1,
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 81.5, 208.6474609375, 62.0, 23.0 ],
					"textcolor" : [ 0.952941176470588, 0.733333333333333, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 28.0, 208.6474609375, 63.0, 23.0 ],
					"textcolor" : [ 0.952941176470588, 0.733333333333333, 0.074509803921569, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 793.0, 74.5, 46.5, 23.0 ],
					"prototypename" : "float",
					"textcolor" : [ 0.952941176470588, 0.733333333333333, 0.074509803921569, 1.0 ]
				}
