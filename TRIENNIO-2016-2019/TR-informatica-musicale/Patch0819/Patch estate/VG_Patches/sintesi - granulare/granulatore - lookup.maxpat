...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 684.0, 567.0, 24.0, 24.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 2,
					"numoutlets" : 0,
					"patching_rect" : [ 715.5, 567.0, 35.0, 22.0 ],
					"text" : "dac~"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "signal", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 726.0, 418.0, 22.0, 140.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 386.0, 112.0, 22.0 ],
					"text" : "*~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 781.0, 175.355506896972656, 141.0, 47.0 ],
					"text" : "< frequenza di lettura sincrona per segnale ed inviluppo"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 726.0, 175.355506896972656, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 210.127578735351563, 52.0, 22.0 ],
					"text" : "phasor~"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 804.0, 276.0, 44.0, 20.0 ],
					"text" : "< t1/t2"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 245.0, 40.0, 22.0 ],
					"text" : "-~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 749.5, 276.0, 50.0, 22.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 312.0, 43.0, 22.0 ],
					"text" : "*~ 2."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 819.0, 351.0748291015625, 74.0, 22.0 ],
					"text" : "lookup~ env"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 397.0, 245.0, 18.0, 42.0 ],
					"preset_data" : [ 						{
							"number" : 1,
							"data" : [ 5, "obj-32", "flonum", "float", 1.200000047683716, 5, "obj-77", "flonum", "float", 0.0 ]
						}
, 						{
							"number" : 2,
							"data" : [ 5, "obj-32", "flonum", "float", 10.0, 5, "obj-77", "flonum", "float", 0.0 ]
						}
, 						{
							"number" : 3,
							"data" : [ 5, "obj-32", "flonum", "float", 0.899999976158142, 5, "obj-77", "flonum", "float", 0.439999997615814 ]
						}
 ]
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 726.0, 351.0748291015625, 70.0, 22.0 ],
					"text" : "lookup~ sig"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 404.833333333333485, 170.855506896972656, 29.5, 22.0 ],
					"text" : "1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 404.833333333333485, 145.54095458984375, 58.0, 22.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 333.5009765625, 144.985054016113281, 43.666667938232422, 28.0 ],
					"text" : "amp"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 299.83349609375, 73.474082946777344, 27.333332061767578, 28.0 ],
					"text" : "T2"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 326.66693115234375, 170.855506896972656, 66.0, 31.0 ],
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 299.83349609375, 98.230125427246094, 75.0, 31.0 ],
					"tricolor" : [ 0.843137254901961, 0.847058823529412, 0.066666666666667, 1.0 ]
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "int", "", "" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 273.0, 30.0, 130.0, 31.0 ]
				}
...
,
					"patching_rect" : [ 273.0, 217.088798522949219, 99.500381469726563, 26.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "bang" ],
					"patching_rect" : [ 569.19464111328125, 60.950332641601563, 86.666664123535156, 26.0 ],
					"text" : "loadbang"
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 454.49993896484375, 356.0748291015625, 45.25, 28.0 ],
					"text" : "Inv1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 294.0, 82.0, 26.0 ],
					"text" : "r EndFun"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "" ],
					"patching_rect" : [ 273.0, 325.15716552734375, 47.0, 22.0 ],
					"text" : "set env"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 273.19464111328125, 356.0748291015625, 223.333343505859375, 124.135734558105469 ],
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 569.19464111328125, 34.444869995117188, 87.0, 28.0 ],
					"text" : "Segnale1"
				}
...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 569.19464111328125, 90.700912475585938, 80.0, 31.0 ],
					"tricolor" : [ 0.843137254901961, 0.847058823529412, 0.066666666666667, 1.0 ]
				}
...
,
					"patching_rect" : [ 569.19464111328125, 130.768341064453125, 87.0, 26.0 ],
					"saved_object_attributes" : 					{
						"description" : "",
						"digest" : "",
						"globalpatchername" : "",
...
, 			{
				"box" : 				{
					"bgcolor" : [ 0.396078431372549, 0.674509803921569, 0.847058823529412, 1.0 ],
					"buffername" : "sig",
					"fontsize" : 16.0,
					...
					"numoutlets" : 6,
					"outlettype" : [ "float", "float", "float", "float", "list", "" ],
					"patching_rect" : [ 569.19464111328125, 165.928878784179688, 85.75, 84.39739990234375 ],
					"selectioncolor" : [ 0.313726, 0.498039, 0.807843, 0.0 ],
					"setunit" : 1
				}
