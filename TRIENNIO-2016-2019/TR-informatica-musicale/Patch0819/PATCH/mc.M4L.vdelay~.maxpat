...
, 			{
				"box" : 				{
					...
					"outlettype" : [ "", "bang" ],
					"parameter_enable" : 0,
					"patching_rect" : [ 160.0, 80.0, 40.0, 20.0 ],
					"prototypename" : "Live",
					"triscale" : 0.75
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 2,
					"outlettype" : [ "", "" ],
					"patching_rect" : [ 160.0, 56.0, 68.0, 20.0 ],
					"text" : "patcherargs"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "float" ],
					"patching_rect" : [ 160.0, 104.0, 44.0, 20.0 ],
					"text" : "!/ 1000."
				}
...
, 			{
				"box" : 				{
					...
					"numinlets" : 1,
					"numoutlets" : 0,
					"patching_rect" : [ 16.0, 8.0, 154.0, 33.0 ],
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 160.0, 128.0, 50.0, 20.0 ],
					"text" : "cycle~ 5"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 160.0, 152.0, 32.5, 20.0 ],
					"text" : "+~ 1"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 160.0, 176.0, 37.0, 20.0 ],
					"text" : "*~ 0.5"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 344.0, 36.0, 20.0 ],
					"text" : "mc.+~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 152.0, 304.0, 34.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "multichannelsignal" ],
					"patching_rect" : [ 80.0, 304.0, 34.0, 20.0 ],
					"text" : "mc.*~"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 80.0, 272.0, 75.0, 20.0 ],
					"text" : "mc.tapout~ 0 0"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 232.0, 193.0, 40.0, 20.0 ],
					"text" : "!-~ 1."
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 184.0, 232.0, 67.0, 20.0 ],
					"text" : "sah~ 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"numoutlets" : 1,
					"outlettype" : [ "signal" ],
					"patching_rect" : [ 112.0, 232.0, 67.0, 20.0 ],
					"text" : "sah~ 0.0001"
				}
...
, 			{
				"box" : 				{
					...
					"patching_rect" : [ 112.0, 176.0, 34.0, 20.0 ],
					"text" : "line~"
				}
...
, 			{
				"patchline" : 				{
					...
					"midpoints" : [ 161.5, 332.5, 106.5, 332.5 ],
					"source" : [ "obj-22", 0 ]
				}
